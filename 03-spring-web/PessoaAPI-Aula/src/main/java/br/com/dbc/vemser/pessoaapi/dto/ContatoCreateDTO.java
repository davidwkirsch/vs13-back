...
public class ContatoCreateDTO {
    ...
    @Schema(description = "Número do Contato", required = true, example = "11999999999")
    ...
    @Schema(description = "Descrição do Contato", required = true, example = "Telefone comercial")
